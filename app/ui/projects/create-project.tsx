...
export default function CreateProjectForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-3 mt-3 border-black rounded-[4px] border-2 max-w-4xl">
      <div className="flex flex-col gap-4">

        {/* Required Section */}
        <fieldset>
          <legend className="font-semibold mb-2">Required</legend>
        ...
        {/* Optional Section */}
        <fieldset>
          <legend className="font-semibold mb-2">Optional</legend>
        ...
        {/* Submit Button */}
        <Button type="submit" className="mt-4 flex items-center gap-2 bg-[#C0C0C0] text-black hover:bg-[#C0C0C0]">
